...
class ChangePasswordModal extends HTMLElement {
  constructor() {
    ...
    container.innerHTML = `
      ...
      <p>Introduce y repite tu nueva contraseña</p>
      <input id="input1" type="password" placeholder="Nueva contraseña" />
      <input id="input2" type="password" placeholder="Repite la contraseña" />
      <div class="button-group">
        <button class="confirm" id="confirm">Aceptar</button>
